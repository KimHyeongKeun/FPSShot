...
public class ExplosionBarrel : InteractionObject
{
    ...
    [SerializeField]
    private GameObject explosionPrehab;
    [SerializeField]
    ...
    private IEnumerator ExplodeBarrel()
    {
        ...
        Instantiate(explosionPrehab, new Vector3(bounds.center.x, bounds.min.y, bounds.center.z), transform.rotation);
        ...
        foreach(Collider hit in colliders)
        {
            ...
            //폭발 범위에 부딪힌 오브젝트가 상호작용 오브젝트이면 TakeDamage()로 피해줌
